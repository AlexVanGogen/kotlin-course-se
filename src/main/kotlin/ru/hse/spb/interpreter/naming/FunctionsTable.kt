...
class FunctionsTable {
    val functions: MutableSet<FunctionDeclaration> = mutableSetOf()
    ...
    fun getFunctionDeclarationOrNullFor(call: FunctionCallExpression) = functions.find { it.name == call.name }
}